...
int CH264Handle::info2 = 0;
int CH264Handle::info3 = 0;
int CH264Handle::m_SpsLen = 0;
unsigned char CH264Handle::m_Sps[64];
int CH264Handle::m_PpsLen = 0;
unsigned char CH264Handle::m_Pps[64];

static char*	m_pFileName = "test.264";
static FILE*	m_bitStream = NULL;
...
{
	int size = 0;
	NALU_t* n = CH264Handle::AllocNALU(80000000); 
